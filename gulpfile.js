...
const isMarkupEjs = false; // EJSを使用する場合
...
const addDir = "";  // WPのインストール先がデフォルトから変わっている場合設定 ※追加する場合は"/"で終わること
const staticBase = "./dist";
const wpThemesBase = `../app/public/${addDir}wp-content/themes/${themesDir}`;
/********************* 設定ここまで **********************/
